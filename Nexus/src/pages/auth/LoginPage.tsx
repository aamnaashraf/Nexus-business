...
export const LoginPage: React.FC = () => {
  ...
  const loginAsDemo = async (userRole: UserRole) => {
    setError(null);
    setIsDemoLoading(userRole);
    const demoEmail = userRole === 'entrepreneur' ? 'ahmed@test.com' : 'haya@zahra.com';
    try {
      await login(demoEmail, 'Test123!', userRole);
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-2 gap-3">
              <Button
                ...
                isLoading={isDemoLoading === 'entrepreneur'}
              ...
              <Button
                ...
                isLoading={isDemoLoading === 'investor'}
                disabled={!!isDemoLoading || isLoading}
